...
const Feed = () => {
  ...
  const progress = Math.round(((currentIndex + 1) / feed.length) * 100);
      ...
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto mt-16 grid grid-cols-3 gap-4 animate-slide-up" style={{animationDelay: "0.2s"}}>
          <div className="card-base p-6 text-center hover-lift">
            <p className="text-3xl font-black text-gradient">{feed.length}</p>
            <p className="text-sm text-neutral-600 mt-2">Developers Found</p>
          </div>
          <div className="card-base p-6 text-center hover-lift">
            <p className="text-3xl font-black text-gradient">{currentIndex + 1}</p>
            <p className="text-sm text-neutral-600 mt-2">Reviewed</p>
          </div>
          <div className="card-base p-6 text-center hover-lift">
            <p className="text-3xl font-black text-gradient">{feed.length - currentIndex - 1}</p>
